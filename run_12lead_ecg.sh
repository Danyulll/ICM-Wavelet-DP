...
# 4) Compile & run 12-lead ECG dataset
echo "Running 12-lead ECG dataset analysis..."
cargo run --release -- --mode data --dataset 12lead_ecg

echo "12-lead ECG analysis completed!"
